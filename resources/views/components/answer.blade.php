      ...
      <div class="max-w-2xl px-8 py-4 bg-white rounded-lg shadow-md my-8 mx-auto">
          <div class="flex items-center justify-between">
              ...
              <div class="mt-2">
                <p class="mt-2 text-gray-600">回答：{{$answer_comment}}</p>
              </div>
          <div>
            <form action="{{$answer_item_URL}}" method="GET" class="w-full max-w-lg">
            @csrf
            <x-button class="bg-gray-100 text-gray-900">{{ __('おすすめ商品はこちら！') }}</x-button>
          </form>
        </div>
